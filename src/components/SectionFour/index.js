...
const SectionFour = () => {
    return (
        <div className="s-4-container">
            <p className="s-3-head-1">Takeback Solutions</p>
            <h1 className="s-4-head-1">Efficient Packaging REUSE with our Takeback Solutions</h1>
            <div className="s-4-card-1">
                ...
                <div className="s-4-card-1-inner-1">
                    ...
                    <p className="s-3-head-1 s-4-head-2">Collect - Channel - Reuse</p>
                    <p className="s-3-para-1 s-4-para-1">Our ‘Plastic Takeback Solutions’ aim to eliminate the impact <br /> of post-consumer plastic waste in the environment, by using <br /> technology enabled takeback and recycling programs.</p>
