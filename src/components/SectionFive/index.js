...
const SectionFive = () => {
    return (
        <div className="s-5-container">
            <p className="s-3-head-1">IEC Awareness Programs</p>
            <h1 className="s-4-head-1">Information, Education & Communication</h1>
            <div className="s-4-card-1">
                <div className="s-4-card-1-inner-1 s-5-card-1">
                    ...
                    <p className="s-3-head-1 s-4-head-2">Change begins with awareness</p>
                    <p className="s-3-para-1 s-4-para-1">Our comprehensive IEC Awareness <br />
